...
void arrObj::bubbleSort()
{
    ...
    do{
        ...
        for (int n = 1; n < arrSize; n++) {
                 ...
                 // it first sets swap to 1 (so we do-while again, then it swaps.
                 // In my implementation, I use the variable temp to store
                 // array[n-1]s valueÉ copy the value in array[n] to array[n-1]
