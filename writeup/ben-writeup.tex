...
Our Java program ran in about 2 hours, on list sizes $n = $ \{10, 50, 100, 500, 1000, 5000, 10000, 50000, 100000\}. 
...
\end{tabular}
\end{center}
\caption{Java average run times (seconds) of unordered lists (100 trials)}
\end{table}
